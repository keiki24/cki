...
mod tests {
    ...
    fn find_article_from_id() {
        ...
        assert_eq!(article.title, "Dummy title");
        assert_eq!(article.slug, Some("example".to_string()));
        assert_eq!(article.date, NaiveDate::from_ymd(2000, 1, 1));
    }

    #[test]
    fn convert_slugged_id_ti_metadata() {
